...
window.STORE_PRODUCTS = Object.freeze([
    ...
    { id: 'assado-tiras', name: 'Assado de Tiras', price: 70, unit: 'por kg', category: 'carnes', image: './assets/images/assado-tiras.png', description: 'Tiras assadas na brasa, douradas e saborosas.' },
    ...
    { id: 'maminha', name: 'Maminha', price: 65, unit: 'por kg', category: 'carnes', image: './assets/images/maminha.webp', description: 'Maminha suculenta, assada lentamente.' },
    { id: 'costela-bovina', name: 'Costela Bovina', price: 60, unit: 'por kg', category: 'carnes', image: './assets/images/costela-bovina.jpg', description: 'Costela assada lentamente até ficar macia.' },
    ...
    { id: 'linguica-recheada', name: 'Linguiça Recheada', price: 6, unit: 'por unidade', category: 'linguicas', image: './assets/images/linguica-recheada.webp', description: 'Linguiça recheada e assada na brasa, vendida por unidade.' },
    { id: 'linguica-cuiabana', name: 'Linguiça Cuiabana', price: 25, unit: 'por unidade', category: 'linguicas', image: './assets/images/linguica-recheada-rolo.png', description: 'Linguiça Cuiabana artesanal, suculenta e assada na brasa, vendida por unidade.' },
    ...
    { id: 'frango-mandioca-bacon', name: 'Frango Recheado com Mandioca e Bacon', price: 53, unit: 'por unidade', category: 'frango', image: './assets/images/frango-mandioca-bacon.webp', description: 'Frango inteiro com recheio de mandioca e bacon.' },
    ...
    { id: 'abacaxi-assado', name: 'Abacaxi Assado', price: 20, unit: 'por unidade', category: 'acompanhamentos', image: './assets/images/abacaxi.jpg', description: 'Abacaxi assado com toque de especiarias.' }
]);
